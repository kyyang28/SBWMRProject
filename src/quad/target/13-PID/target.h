...
#define ULTRASOUND_1_TRIGGER	PC5
#define ULTRASOUND_1_ECHO		PD11

#define ULTRASOUND_2_TRIGGER	PD8
#define ULTRASOUND_2_ECHO		PD9
//#define ULTRASOUND_2_TRIGGER	PC10
//#define ULTRASOUND_2_ECHO		PC11

//#define ULTRASOUND_3_TRIGGER	PC12
#define ULTRASOUND_3_TRIGGER	PD10
#define ULTRASOUND_3_ECHO		PD0

#define ULTRASOUND_4_TRIGGER	PD1
#define ULTRASOUND_4_ECHO		PD2

#define ULTRASOUND_5_TRIGGER	PD3
#define ULTRASOUND_5_ECHO		PD4

#define ULTRASOUND_6_TRIGGER	PD6
#define ULTRASOUND_6_ECHO		PD7
...
#define USED_TIMERS             			( TIM_N(1) | TIM_N(2) | TIM_N(3) | TIM_N(4) | TIM_N(5) | TIM_N(6) | TIM_N(7) | TIM_N(8) | TIM_N(9) | TIM_N(10) | TIM_N(11) )		// BITCOUNT(USED_TIMERS) = 6
